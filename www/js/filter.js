 ...
 * @returns 简单敏感词过滤
 */
function sw_buildMap(){for(var e=["fuck","一夜情","一夜欢","乳交","傻逼","兽交","口交","口爆","叫床","妈逼","同性恋","屄","屌","强奸","强暴","性交","性奴","情趣用品","操他妈","操你全家","操你大爷","操你妈","操逼","有码","无码","暴乳","松岛枫","法轮","淫","淫妇","淫虫","炮友","爆乳","狗杂种","疆独","肉茎","肏","苍井","草他妈","草它妈","草她妈","草你吗","草你妈","藏独","轮奸","迷奸","生奸","骚穴","台独","暖床"],t={},r=e.length,n=0;n<r;++n)
